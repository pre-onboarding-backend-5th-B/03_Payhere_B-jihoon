...
class MoneyBookLog(models.Model):
    ...
    cash = models.IntegerField(validators=[MinValueValidator(0)], default=0, help_text='수입/지출 금액')
    money_status = models.CharField(max_length=2, choices=MONEY_STATUS_CHOICES, blank=False ,null=False)
